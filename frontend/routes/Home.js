...
import useWindowDimensions from "../components/WindowProp.js";
...
const Homepage = () => {
  ...
  useEffect(() => {
    ...
    setMobile(width < convertRemToPixels(80));
  }, [height, width]);
  return (
    <body className="bg-primary-100 dark:bg-gray-700 overflow-x:hidden">
      ...
      {!mobile && (
        <ThemeProvider theme={theme}>
          ...
          <Box sx={{ marginTop: "5rem" }} className="hidden md:block">
            <div
              style={{ position: "relative", height: "41.5rem" }}
              ...
              >
                <h1
                  style={{
                    ...
                    textShadow: "0.12rem 0.12rem 0.18rem rgba(0, 0, 0, 0.5)",
                  }}
                >
      ...
      {mobile && (
        // <div className="block md:hidden w-[100vh] h-[100vh] text-center">
        <div className="block w-[100vh] h-[100vh] flex justify-center">
          <div
            className="dark:bg-gray-700 bg-primary-200 text-center"
            style={{
              position: "absolute",
              top: "50%",
              // left: 0,
          ...
          >
            <h1
              className="w-full text-black dark:text-white bold"
              style={{
                marginLeft: "1.2rem",
                marginTop: "0rem",
                fontSize: "1.9rem",
