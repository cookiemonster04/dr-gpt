              ...
              <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button 
                      type="Submit Now" 
                      class="text-gray-900 dark:text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm rem-0.36 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        Save
                      </button>
                  </div>
                  
                  <Link to={{ pathname: "/chat", state: { dataArray: dataArray } }}>
                    <button class="text-gray-900 dark:text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm rem-0.36 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                      Go to Chat
                    </button>
                  </Link>
                </form>
